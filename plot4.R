# This script reads the data and generates the fourth plot. 
...
# Plot UpperRight
      plot(df_HPC$DateTime, df_HPC$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
# Plot LowerRight
      plot(df_HPC$DateTime, df_HPC$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
